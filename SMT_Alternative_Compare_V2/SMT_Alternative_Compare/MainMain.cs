...
namespace SMT_Alternative_Compare
{
    public partial class MainMain : Form
    {
        ...
        private void btnSelectFileETSD1_Click(object sender, EventArgs e)
        {
            this.ClickSelectFile(Model.TypeClick.FILE_DOWNLOAD_ETSD_1);
        }
        private void btnSelectFileETSD2_Click(object sender, EventArgs e)
        {
            this.ClickSelectFile(Model.TypeClick.FILE_DOWNLOAD_ETSD_2);
        }

        private void btnSelectFileLinkData1_Click(object sender, EventArgs e)
        {
            this.ClickSelectFile(Model.TypeClick.FILE_LINK_DATA_1);
        }
        private void btnSelectFileLinkData2_Click(object sender, EventArgs e)
        {
            this.ClickSelectFile(Model.TypeClick.FILE_LINK_DATA_2);
        }
                ...
                default:
                    switch (typeClick)
                    {
                        ...
                        case Model.TypeClick.FILE_2:
                            ...
                            break;
                        case Model.TypeClick.FILE_DOWNLOAD_ETSD_1:
                            this.txtFileETSD1.Text = tempResult;
                            break;
                        case Model.TypeClick.FILE_DOWNLOAD_ETSD_2:
                            this.txtFileETSD2.Text = tempResult;
                            break;
                        case Model.TypeClick.FILE_LINK_DATA_1:
                            this.txtFileLinkData1.Text = tempResult;
                            break;
                        case Model.TypeClick.FILE_LINK_DATA_2:
                            this.txtFileLinkData2.Text = tempResult;
                            break;
                    }
                    break;
            }
        ...
        private void MainMain_Load(object sender, EventArgs e)
        {
            ...
            this.txtFile1.Text = @"P:\96. Share Data\99. Other\13. IT\HOAI\SMT-Compare_A\TEST\XRHP06733.csv";
            this.txtFile2.Text = @"P:\96. Share Data\99. Other\13. IT\HOAI\SMT-Compare_A\TEST\XRHP06801.csv";

            this.txtFileETSD1.Text = @"P:\96. Share Data\99. Other\13. IT\HOAI\SMT-Compare_A\TEST\20230213165727-MS010.csv";
            this.txtFileETSD2.Text = @"P:\96. Share Data\99. Other\13. IT\HOAI\SMT-Compare_A\TEST\20230213165759-MS010.csv";

            this.txtFileLinkData1.Text = @"P:\96. Share Data\99. Other\13. IT\HOAI\SMT-Compare_A\TEST\S001-0816-02-XRHP6846 1.8.8.4 Bottom33.csv";
            this.txtFileLinkData2.Text = @"P:\96. Share Data\99. Other\13. IT\HOAI\SMT-Compare_A\TEST\S001-0818-03-XRHP6801-NEW 1.8.8.4 Bottom01.csv";
        ...
        {
            this.dgvResult.Columns[0].HeaderText = this.getInfo.wo1;
            this.dgvResult.Columns[1].HeaderText = "Vi tri 1";
            this.dgvResult.Columns[2].HeaderText = "Ghi chu 1";
            this.dgvResult.Columns[3].HeaderText = this.getInfo.wo2;
