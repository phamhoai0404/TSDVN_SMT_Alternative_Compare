...
namespace SMT_Picklist_Compare.Function
{
    public class MyFunction
    {
        ...
        public static void AddCommentOther(ref List<DataOut> listDataOut, Input valueInput)
        {
            ...
            {
                if (!string.IsNullOrWhiteSpace(itemComment1.comment))
                {
            ...
            {
                if (!string.IsNullOrWhiteSpace(itemComment2.comment))
                {
            ...
            if (check1 == true)
            {
                ...
                foreach (var itemIn in listDataOut)
                {
                    ...
                    {
                        var listObject = listLink1.Find(x => x.itemName == itemIn.col_1);
                        if (listObject != null)
                        {
            ...
            if(check2 == true)
            {
                ...
                foreach (var itemIn in listDataOut)
                {
                    ...
                    {
                        var listObject = listLink2.Find(x => x.itemName == itemIn.col_2);
                        if (listObject != null)
                        {
